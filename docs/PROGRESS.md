...
4. Фаза 7 — курьерская доставка (нужен полный адрес получателя), карта ПВЗ на чекауте, блочный чекаут через Store API, i18n и `readme.txt` для каталога WordPress.org.
